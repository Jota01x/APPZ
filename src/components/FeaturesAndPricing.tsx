        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto px-4">
          ...
          >
            ...
            <div className="mb-10 flex flex-col">
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-5xl sm:text-6xl lg:text-7xl font-black text-white tracking-tighter">125,00</span>
              </div>
              <div className="mt-2">
          ...
          >
            ...
            <div className="mb-10 flex flex-col">
              ...
              <div className="mb-2">
                <span className="text-yellow-900/50 font-bold uppercase text-sm tracking-[0.2em] line-through italic">DE R$ 495,00</span>
              </div>
              ...
              <div className="mt-2 flex flex-col gap-1">
                <span className="text-yellow-950 font-black uppercase text-sm tracking-widest">
                  OU R$ 195,00 À VISTA
                </span>

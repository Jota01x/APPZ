      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            ...
            <div className="hidden md:block absolute top-0 right-0 w-[600px] h-[600px] bg-yellow-500/10 rounded-full blur-[150px] -mr-96 -mt-96 pointer-events-none" />
            ...
            <div className="flex-grow flex flex-col justify-center relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-10">
              <nav className="flex flex-col space-y-4 sm:space-y-6">
                {menuItems.map((item, index) => (
                  ...
                  >
                    <span className="text-yellow-500/40 font-mono text-sm sm:text-xl font-bold md:group-hover:text-yellow-500 transition-colors">
                      0{index + 1}
                    </span>
                    <span className="text-4xl sm:text-8xl font-black text-white md:group-hover:text-yellow-500 md:group-hover:translate-x-4 transition-all uppercase tracking-tighter italic will-change-transform">
                      {item.label}
                    </span>
                  </motion.a>
                ))}
              ...
              >
                <a
                  href="#pricing"
                  onClick={() => setIsMenuOpen(false)}
                  className="inline-flex items-center gap-3 px-8 py-4 bg-yellow-500 text-black font-black uppercase text-sm tracking-widest rounded-full hover:bg-yellow-400 transition-all shadow-[0_0_40px_rgba(234,179,8,0.2)] md:hover:scale-105 active:scale-95 will-change-transform"
                >
                  Começar Agora
                  <ArrowRight size={18} />
                </a>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div>
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-9xl font-black text-white tracking-tighter leading-[0.95] sm:leading-[0.9] mb-8 uppercase max-w-[15ch] sm:max-w-none mx-auto will-change-transform">
            CRIE SITES/APPS EM <span className="text-yellow-500 md:text-white md:animate-[colorShift_4s_infinite_ease-in-out]">2 MINUTOS</span>{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <motion.a 
              ...
              className="w-full sm:w-auto bg-yellow-500 text-black px-8 py-5 sm:px-12 sm:py-6 rounded-2xl text-base sm:text-xl font-black uppercase tracking-tighter hover:bg-yellow-400 transition-all flex items-center justify-center gap-3 whitespace-nowrap group shadow-[0_0_20px_rgba(234,179,8,0.2)] md:animate-[pulse_2s_infinite_ease-in-out] will-change-transform"
            >
